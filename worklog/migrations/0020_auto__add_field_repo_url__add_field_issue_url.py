...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repo.url'
        db.add_column(u'worklog_repo', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Issue.url'
        db.add_column(u'worklog_issue', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repo.url'
        db.delete_column(u'worklog_repo', 'url')

        # Deleting field 'Issue.url'
        db.delete_column(u'worklog_issue', 'url')
