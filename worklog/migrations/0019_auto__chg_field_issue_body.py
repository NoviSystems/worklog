...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'worklog_issue', 'body', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Issue.body'
        db.alter_column(u'worklog_issue', 'body', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
