...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.body'
        db.add_column(u'worklog_issue', 'body',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'Issue.open'
        db.add_column(u'worklog_issue', 'open',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Issue.assignee'
        db.add_column(u'worklog_issue', 'assignee',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Issue.body'
        db.delete_column(u'worklog_issue', 'body')

        # Deleting field 'Issue.open'
        db.delete_column(u'worklog_issue', 'open')

        # Deleting field 'Issue.assignee'
        db.delete_column(u'worklog_issue', 'assignee_id')
    ...
    models = {
        ...
        u'worklog.biweeklyemployee': {
            ...
            'github_user': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        u'worklog.issue': {
            ...
            'body': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
