...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'worklog_workday', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workdays', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('reconciled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'worklog', ['WorkDay'])


    def backwards(self, orm):
        # Deleting model 'WorkDay'
        db.delete_table(u'worklog_workday')
